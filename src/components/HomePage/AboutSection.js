...
const AboutSection = () => {
  return (
    <SectionWrapper>
      <section className="overflow-hidden pt-20 pb-12 lg:pt-[120px] lg:pb-[90px] w-max-8xl px-6">
          ...
          <div className="flex flex-wrap gap-16 items-center justify-center">
            ...
            <div className="w-full  lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                <SectionTitle
                  title="About Us"
                  description="We are a team of designers and developers that create high quality HTML Template &amp; WordPress Theme."
                  align="left"
                />
